...
{/*=============n=================================== Modale6 ende =======================================================================================*/}
                ...
                <div className="w-full flex flex-col justify-between p-4 leading-normal">
                  ...
                  <p className="md:newspaperA mb-1 font-normal text- text-gray-100 dark:text-gray-400">
                    ...
                    Feierabend nette und interessante Menschen kennenzulernen.
          ...
          {/*========================================================== section E =ende ==============================================================*/}
          <h1 className="z-20 relative headingB text-[2rem] text-center text-gray-50 lg:headingA lg:text-yellow-500 lg:text-[4.66rem] lg:mt-12">
            ...
            <ThemeProvider theme={theme}>
              <div className=" mx-auto lg:w-11/12 lg:max-w-8xl grid grid-cols-1 justify-center items-center p-2 md:p-6  md:grid-cols-3 md:justify-around lg:items-center lg:gap-x-3">
                ...
                >
                  ...
                  <Text>
                    <p className="mt- text-center font-bold text-3xl md:text-4xl ">
                      Impressionen
                    </p>
                  </Text>
                </Card>
                ...
                >
                  ...
                  <Text>
                    <p className="mt- text-center font-bold text-3xl md:4xl ">
                      Impressionen
                    </p>
                  </Text>
                </Card>

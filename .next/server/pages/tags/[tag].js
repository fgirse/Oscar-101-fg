...
const { replace  } = '';
// escape
const es1 = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34);/g;
const ca = /[&<>'"]/g;
const esca = {
    '&': '&amp;',
    '<': '&lt;',
...
/* harmony import */ var _lib_generate_rss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(3440);
/* harmony import */ var _lib_mdx__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(6852);
/* harmony import */ var _lib_tags__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(7532);
/* harmony import */ var _lib_utils_kebabCase__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(7836);
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_lib_mdx__WEBPACK_IMPORTED_MODULE_6__, _lib_tags__WEBPACK_IMPORTED_MODULE_7__]);
([_lib_mdx__WEBPACK_IMPORTED_MODULE_6__, _lib_tags__WEBPACK_IMPORTED_MODULE_7__] = __webpack_async_dependencies__.then ? await __webpack_async_dependencies__ : __webpack_async_dependencies__);
...
async function getStaticPaths() {
    const tags = await (0,_lib_tags__WEBPACK_IMPORTED_MODULE_7__/* .getAllTags */ .Y)("blog");
    return {
...
async function getStaticProps({ params  }) {
    const allPosts = await (0,_lib_mdx__WEBPACK_IMPORTED_MODULE_6__/* .getAllFilesFrontMatter */ .sj)("blog");
    const filteredPosts = allPosts.filter((post)=>post.draft !== true && post.tags.map((t)=>(0,_lib_utils_kebabCase__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .Z)(t)
        ).includes(params.tag)
    );
    // rss
    const rss = (0,_lib_generate_rss__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z)(filteredPosts, `tags/${params.tag}/feed.xml`);
    const rssPath = path__WEBPACK_IMPORTED_MODULE_10___default().join(root, "public", "tags", params.tag);
    fs__WEBPACK_IMPORTED_MODULE_9___default().mkdirSync(rssPath, {
        recursive: true
    });
    fs__WEBPACK_IMPORTED_MODULE_9___default().writeFileSync(path__WEBPACK_IMPORTED_MODULE_10___default().join(rssPath, "feed.xml"), rss);
    return {
        props: {
            posts: filteredPosts,
            tag: params.tag
...
function Tag({ posts , tag  }) {
    ...
    return(/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_SEO__WEBPACK_IMPORTED_MODULE_2__/* .TagSEO */ .$t, {
                title: `${tag} - ${(_data_siteMetadata__WEBPACK_IMPORTED_MODULE_3___default().author)}`,
                description: `${tag} tags - ${(_data_siteMetadata__WEBPACK_IMPORTED_MODULE_3___default().author)}`
            }),
...
var __webpack_exports__ = __webpack_require__.X(0, [190,664,373,59,590,717,795], () => (__webpack_exec__(4161)));

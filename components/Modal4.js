    ...
    <>
      <div className="inset-0 flex items-center justify-center">
        <button
          type="button"
          onClick={openModal}
          className="w-max-lg px-4 py-6 lg:text-4xl font-medium text-white bg-amber-600 hover:bg-amber-700 rounded-md bg-opacity-80 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75"
        >
          OpenStreet MAP
        </button>
      </div>

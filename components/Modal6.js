...
import LogoLeckerladen from "./icons/svg/SVGLogoLeckerladen.js";
    ...
    <>
      <div className="inset-0 flex items-center justify-center">
        <button
          type="button"
          onClick={openModal}
          className=" w-max-lg text-1xl px-4 lg:text-1xl font-bold text-white bg-orange-600 hover:bg-slate-500 rounded-md bg-opacity-80 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75"
        >
              ...
              <div className="inline-block w-full max-w-7xl p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-gray-800 bg-opacity-100 border border-white shadow-xl rounded-2xl">
                ...
                <div className="mt-2 lg:mt-1 ">
                  <p className="newspaper">
                    U1nsere Sportarena{" "}
                    <span>
                      <Arena height="120" wwidth=""></Arena>
                    </span>{" "}
                    mit regelmässigen Live-Übertragungen der Fussball-Bundesliga
                    erfreut sich immer grösserer Belibtheit. Insbesondere zu den
                    Topspiel des SC Freiburg empfehlen wir eine
                    Tischreservation. Mit unserem neuen Booking Tool sichern Sie
                    sich die besten Plätze in der Fussball-Arena... Wir freuen
                    uns auf spannende, torreiche Spiele
                    <br />
                    <br />
                    Das Team Rettungsanker."{" "}
                  </p>
                </div>
                <div className="mt-5 flex flex-row justify-evenly gap-5 ">
                  ...
                  <button
                    type="button"
                    className="inline-flex justify-center px-4 py-0 text-3xl md:text-sm font-medium font-sans text-gray-100 bg-orange-600 border border-transparent rounded-md hover:bg-blue-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500"
                    onClick={closeModal}
                  >
                    email
                  </button>

...
(function ($) {
  ...
  $.myTimeline = function () {
    ...
    bar.css(
      "top",
      tl.attr("data-imagesHeight") - tl.attr("data-draggerHeight")
    );
    ...
    preload
      ...
      .animate({ opacity: 0 }, 500, "easeOutQuad");
    ...
    for (var i = 0; i < marksAmount; i++) {
      ...
      current
        ...
        .delay(fadeInDelay + 500)
        .animate(
          { left: current.attr("data-xpos"), opacity: 1 },
          700 + 100 * i,
          "easeOutQuad"
        )
        .show()
  ...
  function startDrag(i) {
    ...
    i.draggable({
      ...
      drag: function (event, ui) {
        ...
        if (ui.position.left < 0 && ui.position.left * -1 > rightLimit)

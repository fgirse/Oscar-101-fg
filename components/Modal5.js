              ...
              <div className="inline-block w-full max-w-7xl p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-gray-800 bg-opacity-100 border border-white shadow-xl rounded-2xl">
                ...
                <div className="mt-2 lg:mt-1 ">
                  <p className="newspaperA text-justify p-3 text-gray-100 text-xs lg:text-xl">
                    ...
                    oder Belegschaftspartys zu gestalten. Im Rahmen einer
                    "geschlossenen Gesellschaft" steht Ihnen der Rettungsanker
                    mit seinen Räumlichkeiten für Ihre Feierlichkeiten zur
                    Verfügung. Auch können wir Ihnen - falls dies erwünscht -
                    ein vollumfängliches{" "}
                    <span className="text-yellow-400 font-bold">Catering</span>{" "}
                    ...
                    Informationen zur Planung Ihres Events besprechen wir am
                    sinnvollsten nach{" "}
                    <span className="text-yellow-400 font-bold">
                      Vereinbarung eines persönlichen Termins
                    </span>
                    . Senden Sie uns eine e-mail oder sprechen Sie uns direkt im
                    Rettungsanker an!!! Wir freuen uns Ihre Feierlichkeiten
                    professionell begleiten zu dürfen.
                    <br />
                    <br />
